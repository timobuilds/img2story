...
def generate_story(scenario):
    ...
    You can generate a short sci-fi love story based on a simple narrative, the story should be no more than 200 words;
...
def main():
    ...
    st.set_page_config(page_title="Image to sci-fi love story", page_icon="🎧")
